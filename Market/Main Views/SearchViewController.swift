...
//  Market
//
//  Created by Hayden Frea on 08/08/2019.
...
class SearchViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        activityIndicator = NVActivityIndicatorView(frame: CGRect(x: self.view.frame.width / 2 - 30, y: self.view.frame.height / 2 - 30, width: 60, height: 60), type: .ballPulse, color: #colorLiteral(red: 0.9771573604, green: 0.465426337, blue: 0.1832221476, alpha: 1), padding: nil)
    }
    ...
    @objc func textFieldDidChange (_ textField: UITextField) {
        ...
        if searchButtonOutlet.isEnabled {
            searchButtonOutlet.backgroundColor = #colorLiteral(red: 0.9771573604, green: 0.465426337, blue: 0.1832221476, alpha: 1)
        } else {
            disableSearchButton()
        }
